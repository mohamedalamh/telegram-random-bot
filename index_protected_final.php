...
function safe_get_contents($file, $default = "") {
    return file_exists($file) ? file_get_contents($file) : $default;
}
...
$update = json_decode(safe_get_contents('php://input'));
...
safe_put_contents('EMIL/emil.json', json_encode($array));
}
function Bemil($array){
safe_put_contents('EMIL/emils.json', json_encode($array));
}
function Now($array){
safe_put_contents('EMIL/emilnow.json', json_encode($array));
}
function OrdAll($array){
safe_put_contents('BUY/Orderall.json', json_encode($array,64|128|256));
}
function NumbBuys($array,$account){
safe_put_contents("EMILS/$account/number.json", json_encode($array,64|128|256));
}
function SendBuys($array,$account){
safe_put_contents("EMILS/$account/send.json", json_encode($array,64|128|256));
}
function CardBuys($array,$account){
safe_put_contents("EMILS/$account/card.json", json_encode($array,64|128|256));
}
function PricBuys($array,$account){
safe_put_contents("EMILS/$account/price.json", json_encode($array,64|128|256));
}
function Ands($array){
safe_put_contents('data/openlock.json', json_encode($array));
}
function Bnds($array){
safe_put_contents('data/addblusdel.json', json_encode($array));
}
function Agent($array){
safe_put_contents('data/txt/agent.json', json_encode($array));
}
function Addserver($array){
safe_put_contents('data/country.json', json_encode($array,64|128|256));
}
function Sool($array){
safe_put_contents('data/txt/sool.json', json_encode($array));
}
function Ready($array){
safe_put_contents('data/storenumber.json', json_encode($array));
}
function Admins($array){
safe_put_contents('data/id/admin.json', json_encode($array));
}
function Save($array){
safe_put_contents('data/txt/random.json', json_encode($array));
}
function Ssai($array){
safe_put_contents("assignment/addem.json",json_encode($array));
}
function Dsai($array){
safe_put_contents("assignment/addid.json",json_encode($array));
}
function Apps($array){
safe_put_contents('data/api/apps.json', json_encode($array,64|128|256));
}
$zzz = json_decode(safe_get_contents("zzz.json"),1);
function zzz(){
global $zzz;
safe_put_contents("zzz.json",json_encode($zzz));
}
$EMIL = json_decode(safe_get_contents('EMIL/emil.json'),true);
$EMILS = json_decode(safe_get_contents('EMIL/emils.json'),true);
$EMILNow = json_decode(safe_get_contents('EMIL/emilnow.json'),true);
$ORDERALL = json_decode(safe_get_contents('BUY/Orderall.json'),true); #تخزين ايدي عمليات جميع الشراء
$openandlock = json_decode(safe_get_contents('data/openlock.json'),true);
$addblusdel = json_decode(safe_get_contents('data/addblusdel.json'),true);
$agents = json_decode(safe_get_contents('data/txt/agent.json'),true);
$buy = json_decode(safe_get_contents('data/country.json'),true);
$sool = json_decode(safe_get_contents('data/txt/sool.json'),true);
$storenumber = json_decode(safe_get_contents('data/storenumber.json'),true);
$admins = json_decode(safe_get_contents('data/id/admin.json'),true);
$random = json_decode(safe_get_contents('data/txt/random.json'),true);
$assignment = json_decode(safe_get_contents('assignment/addem.json'),true);
$assignment2 = json_decode(safe_get_contents('assignment/addid.json'),true);
$APPS = json_decode(safe_get_contents('data/api/apps.json'),true);
#============={أوامر إضافية}===========#
$me = bot('getme',['bot'])->result->username;
$bot="botbot";
$get = safe_get_contents('data/txt/file.txt');
$exxx = explode("\n",$get);
$count = count($exxx);
if($user != null){
...
$money2 = safe_get_contents("data/txt/rubleall.txt"); #الروبل اللكلي#
$poi_money = safe_get_contents("data/txt/pointall.txt"); #الروبل المتبقي#
...
$BUYSNUM = json_decode(safe_get_contents("EMILS/$EM/number.json"),true);
$BUYSSEND = json_decode(safe_get_contents("EMILS/$EM/send.json"),true);
$BUYSCARD = json_decode(safe_get_contents("EMILS/$EM/card.json"),true);
$BUYSPRIC = json_decode(safe_get_contents("EMILS/$EM/price.json"),true);
#_________________
$Detector = safe_get_contents("data/id/$id/restriction.txt");
$step = safe_get_contents("data/id/$id/step.txt");
$twas = safe_get_contents("data/id/$id/twas.txt");
$buynumber = safe_get_contents("data/id/$id/number.txt");
$exstep=explode("|", $step);
$extext = explode("\n", $text);
...
$rubles=safe_get_contents("EMILS/$EM/rubles.txt"); #الرصيد اللكلي#
$Balance = safe_get_contents("EMILS/$EM/points.txt"); #رصيد العضو#
...
#_________________
$chall = "alamh4";
$useradmin = "Mohammed Alamh";
$sim =-1002718615853; #القناة الرسمية
$PAY =-1002816710638; #الارقام المكتملة
$ess =-1002709391963; #عمليات شراء الارقام
$eer =-1002806248967; #اشعارات الايميلات وتحويل الروبل
if($chat_id==834033986){
$sudo=$chat_id;
}elseif($chat_id==834033986){
$sudo=$chat_id;
}else{
$sudo==834033986;
}
...
safe_put_contents("data/id/$id/lift.txt","$EEM");
}
}
...
#=========={رسالة /start}==========#
$liftchal=safe_get_contents("data/id/$id/lift.txt");
...
Dsai($assignment2);
$points = safe_get_contents("EMILS/$liftchal/points.txt");
$as = $points + $assignru;
safe_put_contents("EMILS/$liftchal/points.txt",$as);
$rubles = safe_get_contents("EMILS/$liftchal/rubles.txt");
$ds = $rubles - $assignru;
safe_put_contents("EMILS/$liftchal/rubles.txt",$ds);
$pointall = safe_get_contents("data/txt/pointall.txt");
$alls = $pointall + $assignru;
safe_put_contents("data/txt/pointall.txt",$alls);
$rubleall = safe_get_contents("data/txt/rubleall.txt");
$dlls = $rubleall + $assignru;
safe_put_contents("data/txt/rubleall.txt",$dlls);
...
Dsai($assignment2);
$points = safe_get_contents("EMILS/$EEM/points.txt");
$as = $points + $assignru;
safe_put_contents("EMILS/$EEM/points.txt",$as);
$rubles = safe_get_contents("EMILS/$EEM/rubles.txt");
$ds = $rubles - $assignru;
safe_put_contents("EMILS/$EEM/rubles.txt",$ds);
$pointall = safe_get_contents("data/txt/pointall.txt");
$alls = $pointall + $assignru;
safe_put_contents("data/txt/pointall.txt",$alls);
$rubleall = safe_get_contents("data/txt/rubleall.txt");
...
if(!in_array($id,$exxx)){
safe_put_contents('data/txt/file.txt',"\n" . $id, FILE_APPEND);
}
...
safe_put_contents("data/id/$id/step.txt","login");
exit;
}
...
safe_put_contents("data/id/$id/step.txt","pasword|$text");
exit;
}
...
safe_put_contents("data/id/$id/step.txt","sign_in|$margin");
exit;
}
...
$rubles=safe_get_contents("EMILS/$emile/rubles.txt"); #الرصيد اللكلي#
$Balance = safe_get_contents("EMILS/$emile/points.txt"); #رصيد العضو#
$consumers = $rubles-$Balance; #عدد الروبل المستهلك#
if($Baalanc==null){
$Baalanc=0;
}
...
$points = safe_get_contents("EMILS/$EM/points.txt");
$as = $points - $price;
safe_put_contents("EMILS/$EM/points.txt",$as);
$pointall = safe_get_contents("data/txt/pointall.txt");
$alls = $pointall - $price;
safe_put_contents("data/txt/pointall.txt",$alls);
$ORDERALL[card] +=1;
...
safe_put_contents("data/id/$id/step.txt","po");
}
...
$BUYSCARD = json_decode(safe_get_contents("EMILS/$emil/card.json"),true);
...
$ORDERALL[add] +=1;
OrdAll($ORDERALL);
$rubles = safe_get_contents("EMILS/$EM/rubles.txt");
$ds = $rubles - $amount;
safe_put_contents("EMILS/$EM/rubles.txt",$ds);
}
...
safe_put_contents("data/id/$id/step.txt","changepass");
}
}
...
safe_put_contents("data/id/$id/step.txt","se");
}
...
$emils = $exdata[3];
$sendbot2=$sendbot+1;
$cel = safe_get_contents("EMILS/$emils/points.txt");
$to = $cel + $price;
$rubel = $coun-$price;
$geet = $Balance - $coun;
...
$as = $points - $coun;
safe_put_contents("EMILS/$EM/points.txt",$as);
$BUYSPRIC = json_decode(safe_get_contents("EMILS/$emils/price.json"),true);
$idd = count($BUYSPRIC);
...
safe_put_contents("data/id/$id/step.txt","receiptpri");
}
if($text && $text != null && $text != '/start' && $step == "receiptpri"){
$code=$text;
$order = $sool[send][$code][order];
$emil = $sool[send][$code][idsen];
$BUYSSEND = json_decode(safe_get_contents("EMILS/$emil/send.json"),true);
...
SendBuys($BUYSSEND,$EM);
$BUYSPRIC = json_decode(safe_get_contents("EMILS/$idEM/price.json"),true);
...
$BUYSPRIC[$idd][DAY_shipping] = $DAY;
PricBuys($BUYSPRIC,$idEM);
$points = safe_get_contents("EMILS/$emil/points.txt");
$as = $points + $coun;
safe_put_contents("EMILS/$emil/points.txt",$as);
unset($sool['send'][$BUYSSEND[$order][code]]);
Sool($sool);
unlink("data/id/$id/step.txt");
}
...
safe_put_contents("data/id/$id/step.txt","login_2");
}
...
safe_put_contents("data/id/$id/step.txt","pasword_2|$text");
}
}
...
if($code1 == null){ 
$api=json_decode(safe_get_contents("https://mega-ye.net/API/api-sites.php?action=getStatus&bot=$bot&site=$site&idnumber=$idnumber&number=$number&app=$app"),1);
...
$BUYSNUM = json_decode(safe_get_contents("EMILS/$account/number.json"),true);
...
$PHPXX = json_decode(safe_get_contents("PHPXX.json"),true); 
if($data == "super"){
bot('EditMessageText',[
'chat_id'=>$chat_id,
'message_id'=>$message_id,
...
safe_put_contents("data/id/$id/twas.txt","tw");
safe_put_contents("PHPXX.json",json_encode($PHPXX));
}
...
unlink("zzz.json");
safe_put_contents('data/txt/bc.txt','no');
unlink("data/id/$id/step.txt");
}
#=========={رجوع للقائمة}==========#
if($data == 'c'){
...
$cut = explode("\n",safe_get_contents("data/txt/file.txt"));
$users = count($cut)-1;
$modee = safe_get_contents("data/txt/bc.txt");
#Start code 
if ($update && !in_array($id, $cut)) {
safe_put_contents("data/txt/file.txt", $id."\n",FILE_APPEND);
}
if($data == "set"){
bot('EditMessageText',[
'chat_id'=>$chat_id2,
...
safe_put_contents("data/txt/bc.txt","yas1");
}
...
safe_put_contents("data/txt/bc.txt","yas2");
}
